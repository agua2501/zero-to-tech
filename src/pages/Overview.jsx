...
export default function Overview() {
  ...
  return (
    <article className="content">
      ...
      <p className="from">{t("overview_from")}</p>
      <nav className="breadcrumb" aria-label="面包屑导航">
        <Link to="/"><span>首页</span></Link> &gt; <span>{t("nav_overview")}</span> &gt; 正文
      </nav>
      <figure className="img">
        <img loading="lazy" src="/img/R-C.jpg" alt="茂名城市风貌" />
      </figure>
      ...
      <p>2023年，茂名市入选全国数字百强市；获2020—2021年度全国无偿献血先进市奖。</p>
      <p>中共茂名市委书记：庄悦群；市人大常委会主任：庄悦群；市长：王雄飞；市政协主席：刘芳；市纪委书记、监委主任：李长林（任至8月），陈秋生（8月任市纪委书记，9月任市监委副主任、代理主任）。</p>
      <p>
